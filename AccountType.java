...
public abstract class AccountType
{
  ...
  public AccountType(String aUsername, String aPassword, User aPerson, FashionStoreManagementApp aSystem)
  {
    ...
    if (!didAddPerson)
    {
      throw new RuntimeException("Unable to create storeRole due to person. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
    boolean didAddSystem = setSystem(aSystem);
    if (!didAddSystem)
    {
      throw new RuntimeException("Unable to create account due to system. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }
