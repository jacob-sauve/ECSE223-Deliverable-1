...
public class CartItem
{
  ...
  public CartItem(int aQuantity, Size aSize, Cart aCart, ClothingItem aClothingItem)
  {
    ...
    if (!didAddCart)
    {
      throw new RuntimeException("Unable to create cartItem due to cart. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
    boolean didAddClothingItem = setClothingItem(aClothingItem);
    if (!didAddClothingItem)
    {
      throw new RuntimeException("Unable to create cartItem due to clothingItem. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }
