...
public class Manager extends AccountType
{
  ...
  public Manager(String aUsername, String aPassword, User aPerson, FashionStoreManagementApp aSystem, FashionStoreManagementApp aSystem)
  {
    ...
    {
      throw new RuntimeException("Unable to create Manager due to aSystem. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
    system = aSystem;
  ...
  /* Code from template association_AddManyToOne */
  public Shipment addShipment(boolean aShipped, Date aShippingDate, FashionStoreManagementApp aSystem)
  {
    return new Shipment(aShipped, aShippingDate, this, aSystem);
  }
