...
public class ShipmentItem
{
  ...
  public ShipmentItem(Size aSize, int aQuantity, Shipment aOrderedShipment, ClothingItem aItemTypeToShip)
  {
    ...
    {
      throw new RuntimeException("Unable to create shippedItem due to orderedShipment. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
    boolean didAddItemTypeToShip = setItemTypeToShip(aItemTypeToShip);
    if (!didAddItemTypeToShip)
    {
      throw new RuntimeException("Unable to create specificReceivedItem due to itemTypeToShip. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }
