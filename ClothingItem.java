...
public class ClothingItem
{
  ...
  public ClothingItem(String aName, double aPrice, int aLoyaltyPoints, FashionStoreManagementApp aCatalog)
  {
    ...
    if (!didAddCatalog)
    {
      throw new RuntimeException("Unable to create catalogItem due to catalog. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  ...
  public void delete()
  {
    ...
    while (stockedSizes.size() > 0)
    {
      InventoryItem aStockedSize = stockedSizes.get(stockedSizes.size() - 1);
      aStockedSize.delete();
      stockedSizes.remove(aStockedSize);
    }
